...
export default function PatternReturnsChart() {
  ...
  return (
    <Card className="seasonax-card h-full">
      <CardHeader><CardTitle>Pattern Returns ({startDay}–{endDay})</CardTitle></CardHeader>
      <CardContent>
        {loading && <div className="h-64 flex-center">Loading…</div>}
        {!loading && chartData.length === 0 && <div className="h-64 flex-center">No data</div>}
